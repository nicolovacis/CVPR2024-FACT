...
def main():
    parser = argparse.ArgumentParser(description='Preprocess Stanford dataset for FACT (Multi-label: licking & shaking)')
    ...
    print("=" * 80, flush=True)
    print("STANFORD MULTI-LABEL DATASET PREPROCESSING (ORIGINAL FPS)", flush=True)
